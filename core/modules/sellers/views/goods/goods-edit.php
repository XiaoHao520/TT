...
<div class="head">
    ...
    <div class="head-content" flex="dir:left">
        <a flex="cross:center" href="<?=Yii::$app->urlManager->createUrl('sellers/goods/goods')?>"> 返回</a>
        <a flex="cross:center"  href="#step1">选择分类</a>
        <a flex="cross:center"  href="#step2">基本信息</a>
        <a flex="cross:center"  href="#step3">规格/库存</a>
        <a flex="cross:center"  href="#step4">商品详情</a>
    </div>
</div>
...
<div class="panel mb-3" id="page">
    ...
    <div class="panel-body" style="padding: 0 100px;margin-top: 50px">
        <form class="auto-form" method="post" return="<?= $returnUrl ?>">
                                    ...
                                    <?php if (count($goods_pic_list) > 0): ?>
                                        <?php foreach ($goods_pic_list as $item): ?>
                                            <div class="upload-preview text-center">
                                                ...
                                                <span class="upload-preview-tip">750&times;450</span>
            ...
            <div class="step-block" flex="dir:left box:first" hidden>
                <div>
                    <span>营销</span>
