...
class GoodsForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'name', 'price', 'cat_id', 'detail', 'goods_pic_list', 'cover_pic', 'address', 'dock'], 'required'],
            ...
            [['share_commission_first', 'share_commission_second', 'share_commission_third', 'freight', 'longitude', 'latitude', 'time','seller_id'], 'default', 'value' => 0],
