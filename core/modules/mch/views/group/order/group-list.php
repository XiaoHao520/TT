                ...
                <table class="table table-bordered bg-white">
                    <tr>
                        <td colspan="5" style="text-align: right">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addRoboot">添加机器人(<?=$surplus?>)</button>
                        </td>
                    </tr>
                </table>
            </div>
...
<div class="modal fade" id="addRoboot" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
